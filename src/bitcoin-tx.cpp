...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s uscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  uscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded uscoin transaction") + "\n" +
              "  uscoin-tx [options] -create [commands]   " + _("Create hex-encoded uscoin transaction") + "\n" +
              "\n";
